...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/Progetto/Smarty/css/menù.css">

    <script src="/Progetto/Smarty/js/menù.js"></script>
...
<div class="d-flex " style="display: flex ; flex-wrap: wrap; width: 100%;flex-grow: 1;">
    <div class="d-flex flex-row justify-content-center pt-5" style="width: 100%">
        <div class="jumbotron menu">
            <div class="d-flex flex-row justify-content-center pt-5" style="width: 100%">
                <a class="btn lm-auto" href="/Progetto/Admin/utenti">Gestisci Utenti</a>
                <a class="btn rm-auto " href="/Progetto/Admin/serie">Gestisci Serie</a>
            </div>

            <div class="d-flex flex-row justify-content-center pt-5" style="width: 100%">
                <a class="btn lm-auto" href="/Progetto/Admin/lingue">Gestisci Lingue</a>
                <a class="btn rm-auto " href="/Progetto/Admin/generi">Gestisci Generi</a>
            </div>

            <div class="d-flex flex-row justify-content-center pt-5" style="width: 100%">
                <a class="btn lm-auto"href="/Progetto/Admin/commenti">Gestisci Commenti</a>
                <a class="btn rm-auto "href="/Progetto/Admin/voti">Gestisci Voti</a>
            </div>

            <div class="d-flex flex-row justify-content-center pt-5" style="width: 100%">
                <a class="btn lm-auto" href="/Progetto/Admin/watchlist">Gestisci Watchlist</a>
                <a class="btn rm-auto "href="/Progetto/Admin/aggiungiSerie">Aggiungi Serie</a>
            </div>
        </div>
    </div>
</div>
