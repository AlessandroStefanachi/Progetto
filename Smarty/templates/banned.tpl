...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/Progetto/Smarty/css/banned.css">
...
<div class="d-flex " style="display: flex ; flex-wrap: wrap; width: 100%;flex-grow: 1;">
    <span ID="error"> L'ACCOUNT CHE STAI UTILIZZANDO NON HA LA POSSIBILITÀ DI ACCEDERE AL SITO</span>
</div>
</body>
</html>