...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/Progetto/Smarty/css/commenti.css">

    <script src="/Progetto/Smarty/js/commenti.js"></script>
...
<div class="d-flex " style="display: flex ; flex-wrap: wrap; width: 100%;flex-grow: 1;">
    <div class="d-flex flex-row justify-content-center pt-5" style="width: 100%">
        <div class="jumbotron commenti" style="max-height: 40vw">
            <ul>
                <li>
                    <div class="d-flex flex-row justify-content-center pt-2" style="width: 100%">
                        <span class="mr-auto">AUTORE</span> <span class="mx-auto">TESTO</span> <span class="ml-auto">ID EPISODIO</span><span class="ml-auto pl-5"></span></div></li>
                {foreach from=$commenti item=$a }
                    <li>
                        <div class="d-flex flex-row justify-content-center pt-4" style="width: 100%">
                            <a class="mr-auto pr-3 pl-3" href="/Progetto/Utente/user?id={$a->getAutore()}">{$a->getAutore()}</a> <div id="text" class="mx-auto" style="max-height: 10vh; overflow: auto">

                                <span id="testo">{$a->getTesto()}</span>
                            </div>
                            <a class="ml-auto pl-3"href="/Progetto/Episodio/info?id={$a->getIdEpisodio()}">{$a->getIdEpisodio()}</a>
                            <a class="ml-auto pl-3" href="/Progetto/Episodio/eliminaCommento?id={$a->getId()}">elimina</a>
