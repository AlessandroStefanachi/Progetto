...
<head>
    ...
    <script src="/Progetto/Smarty/js/serie.js"></script>
    ...
    <div class="d-flex flex-row justify-content-center pt-5" style="width: 100%">
        <div class="jumbotron serie" style="max-height: 40vw">
            <div class="d-flex flex-row justify-content-center pt-5" style="width: 100%">
                <form class="form-inline">
                    <div class="form-group-inline">
                        <input type="username" class="form-control" name="titolo" id="nome" aria-describedby="nome" placeholder="Nome Watchlist" oninput="" value="{$serie->getTitolo()}">

                    </div>
                    <input class="btn btn-sm"type="submit" id="titolobutton" value="modifica" disabled>
                </form>
            </div>
            ...
            <div class="d-flex flex-row justify-content-center pt-5" style="width: 100%">
                <form class="form-inline">
                    <div class="form-group-inline">
                                        <textarea class="form-control" name="trama" id="trama" >{$serie->getTrama()}</textarea>

                    </div>
                    <input class="btn btn-sm"type="submit" id="modificabutton" value="modifica" disabled>
                </form>
            </div>
