...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/Progetto/Smarty/css/lingue.css">

    <script src="/Progetto/Smarty/js/lingue.js"></script>
...
<div class="d-flex " style="display: flex ; flex-wrap: wrap; width: 100%;flex-grow: 1;">
    <div class="d-flex flex-row justify-content-center pt-5" style="width: 100%">
        <div class="jumbotron lingue" style="max-height: 40vw">
            <ul>
                {foreach from=$lingue item=$a }
                    <li>
                        <div class="d-flex flex-row justify-content-center pt-2" style="width: 100%">
                            <span class="mr-auto">{$a['lingua']}</span> <a class="ml-auto" href="/Progetto/Admin/cancellaLingua?id={$a['lingua']}">rimuovi</a></div></li>
                {/foreach}
            </ul>
            <form method="post" action="/Progetto/Admin/aggiungiLingua">
                <div class="form-group-inline">

                    <input type="username" class="form-control" name="lingua" id="lingua" aria-describedby="nome" placeholder="Lingua" oninput="button()">

                </div>
                <input class="btn"type="submit" id="linguabutton" value="aggiungi" disabled>
            </form>
        </div>
