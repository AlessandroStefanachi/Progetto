...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/Progetto/Smarty/css/creaWatchlist.css">

    <script src="/Progetto/Smarty/js/creaWatchlist.js"></script>
...
<div class="d-flex " style="display: flex ; flex-wrap: wrap; width: 100%;flex-grow: 1;">
    <div class="d-flex flex-row justify-content-center pt-5" style="width: 100%">
        <div class="jumbotron creazione">
          <form method="post" action="/Progetto/Watchlist/salva">
              <div class="form-group">

                  <input type="username" class="form-control" name="nome" id="nome" aria-describedby="nome" placeholder="Nome Watchlist" oninput="crea()">

              </div>
              <div class="form-group">

                 <textarea class="form-control" name="descrizione" id="editarea" >Descrizione Watchlist
 </textarea>

              </div>
              <div class="form-group">
              <div class="form-check form-check-inline">
                  <input class="form-check-input" type="radio" name="accessibilità" id="inlineRadio1" value="Privato" checked>
                  <label class="form-check-label" for="inlineRadio1">Privato</label>
              </div>
              <div class="form-check form-check-inline">
                  <input class="form-check-input" type="radio" name="accessibilità" id="inlineRadio2" value="Pubblico">
                  <label class="form-check-label" for="inlineRadio2">Pubblico</label>
              </div>
              </div>

              <div class="form-group" id="series" style="max-height: 5vw; overflow: auto">
                  {foreach from=$serie[0] item=$a}
                  <div class="form-check">
                      <input class="form-check-input" name="serie[]" type="checkbox" value="{$a->getId()}" id='{$a->getId()}'>
