            ...
            <ul>
                <li>
                    <div class="d-flex flex-row justify-content-center pt-2" style="width: 100%">
                        <span class="mr-auto">Titolo</span></div></li>
                {foreach from=$serie item=$a }
                    <li>
                        <div class="d-flex flex-row justify-content-center pt-4" style="width: 100%">
                            <a class="mr-auto " href="/Progetto/SerieTv/info?id={$a->getId()}">{$a->getTitolo()}</a>
                            <a class="mx-auto " href="/Progetto/Admin/modificaSerie?id={$a->getId()}">modifica</a>
                            <a class="mx-auto " href="/Progetto/Admin/eliminaSerie?id={$a->getId()}">elimina</a>
