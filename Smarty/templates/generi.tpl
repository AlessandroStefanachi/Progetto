...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/Progetto/Smarty/css/generi.css">

    <script src="/Progetto/Smarty/js/generi.js"></script>
...
<div class="d-flex " style="display: flex ; flex-wrap: wrap; width: 100%;flex-grow: 1;">
    <div class="d-flex flex-row justify-content-center pt-5" style="width: 100%">
        <div class="jumbotron generi" style="max-height: 40vw">
            <ul>
                {foreach from=$generi item=$a }
                    <li>
                        <div class="d-flex flex-row justify-content-center pt-2" style="width: 100%">
                            <span class="mr-auto">{$a['genere']}</span> <a class="ml-auto" href="/Progetto/Admin/cancellaGenere?id={$a['genere']}">rimuovi</a></div></li>
                {/foreach}
            </ul>
            <form method="post" action="/Progetto/Admin/aggiungiGenere">
                <div class="form-group-inline">

                    <input type="username" class="form-control" name="genere" id="genere" aria-describedby="nome" placeholder="genere" oninput="button()">

                </div>
                <input class="btn"type="submit" id="generebutton" value="aggiungi" disabled>
            </form>
        </div>
