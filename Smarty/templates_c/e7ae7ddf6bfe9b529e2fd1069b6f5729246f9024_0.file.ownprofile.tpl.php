<?php
/* Smarty version 3.1.34-dev-7, created on 2021-01-08 19:38:40
  from '/opt/lampp/htdocs/Progetto/Smarty/templates/ownprofile.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_5ff8a6b0341b07_88528584',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'e7ae7ddf6bfe9b529e2fd1069b6f5729246f9024' => 
    array (
      0 => '/opt/lampp/htdocs/Progetto/Smarty/templates/ownprofile.tpl',
      1 => 1610130244,
      2 => 'file',
    ),
  ),
...
function content_5ff8a6b0341b07_88528584 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html>
...
<head>
    ...
    <?php echo '<script'; ?>
 src="/Progetto/Smarty/js/profile_edit.js"><?php echo '</script'; ?>
>
...
<ul class="navbar-nav mr-auto"></ul>
        ...
        <ul class="navbar-nav ml-auto" >
           <?php if (!$_smarty_tpl->tpl_vars['self']->value[0]) {?>
            <li class="nav-item" id="poppr">

                <a class="navbar-brand"  href="/Progetto/Utente/user?id=<?php echo $_smarty_tpl->tpl_vars['self']->value[1];?>
">
                    <div class="icon">
...
<?php if ((isset($_smarty_tpl->tpl_vars['pwedit']->value))) {?>
    <?php if ($_smarty_tpl->tpl_vars['pwedit']->value == true) {?>
    ...
    <?php }
if ($_smarty_tpl->tpl_vars['pwedit']->value == false) {?>
...
<?php if ((isset($_smarty_tpl->tpl_vars['emailedit']->value))) {?>
    <?php if ($_smarty_tpl->tpl_vars['emailedit']->value == true) {?>
        <div class="alert alert-success alert-dismissible fade show" role="alert">
    ...
    <?php }?>
    <?php if ($_smarty_tpl->tpl_vars['emailedit']->value == false) {?>
        <div class="alert alert-danger alert-dismissible fade show" role="alert">
...
<?php if ((isset($_smarty_tpl->tpl_vars['usernameedit']->value))) {?>
    <?php if ($_smarty_tpl->tpl_vars['usernameedit']->value == true) {?>
        <div class="alert alert-success alert-dismissible fade show" role="alert">
    ...
    <?php }?>
    <?php if ($_smarty_tpl->tpl_vars['usernameedit']->value == false) {?>
        <div class="alert alert-danger alert-dismissible fade show" role="alert">
    ...
    <div class="d-flex flex-row justify-content-center pt-5" style="width: 100%">
        <div class="jumbotron " id="profile">
            <h1 class="display-4">Profilo privato
                <?php if (!$_smarty_tpl->tpl_vars['self']->value[0]) {?>
                <a methods="post" href="/Progetto/Utente/unfollow?user=<?php echo $_smarty_tpl->tpl_vars['utente']->value->getUsername();?>
"><svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="sameColor" class="bi bi-person-dash" viewBox="0 0 16 16">
                    ...
                    <a methods="post" href="/Progetto/Utente/follow?user=<?php echo $_smarty_tpl->tpl_vars['utente']->value->getUsername();?>
">
  ...
  <path d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H3zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/>
            ...
            <span class="pr-5"><?php echo $_smarty_tpl->tpl_vars['utente']->value->getUsername();?>
</span> <?php if ($_smarty_tpl->tpl_vars['self']->value[0] == true) {?><a class=" pl-5 ml-auto" href="" data-toggle="modal" data-target="#usern" >modifica</a><?php }?>
            </div>
            <hr class="my-2">
            <?php if ($_smarty_tpl->tpl_vars['self']->value[0] == true) {?>
            <span>
  ...
  <path d="M.05 3.555A2 2 0 0 1 2 2h12a2 2 0 0 1 1.95 1.555L8 8.414.05 3.555zM0 4.697v7.104l5.803-3.558L0 4.697zM6.761 8.83l-6.57 4.027A2 2 0 0 0 2 14h12a2 2 0 0 0 1.808-1.144l-6.57-4.027L8 9.586l-1.239-.757zm3.436-.586L16 11.801V4.697l-5.803 3.546z"/>
            ...
            <div class="d-flex flex-row" style="width: 100%">
                <span class="pr-5"><?php echo $_smarty_tpl->tpl_vars['utente']->value->getEmail();?>
</span> <a class=" pl-5 ml-auto" href="" data-toggle="modal" data-target="#emailmodal">modifica</a>
            </div>
            <hr class="my-2">
            <?php }?>
            <?php if ($_smarty_tpl->tpl_vars['self']->value[0] == true) {?>
  ...
  <path fill-rule="evenodd" d="M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z"/>
            ...
            <div id="sgbox">
               <ul>
                   ...
                   <?php if (!(isset($_smarty_tpl->tpl_vars['seguiti']->value))) {
$_smarty_tpl->_assignInScope('seguiti', $_smarty_tpl->tpl_vars['utente']->value->getSeguiti());?> <?php }?>
                   <?php
...
?>
                   <li>
                       <?php if ($_smarty_tpl->tpl_vars['self']->value[0] == true) {?>
                       <a methods="post" href="/Progetto/Utente/unfollow?user=<?php echo $_smarty_tpl->tpl_vars['a']->value;?>
"><svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="sameColor" class="bi bi-person-dash" viewBox="0 0 16 16">
                               <path fill-rule="evenodd" d="M8 5a2 2 0 1 1-4 0 2 2 0 0 1 4 0zM6 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm6 5c0 1-1 1-1 1H1s-1 0-1-1 1-4 6-4 6 3 6 4zm-1-.004c-.001-.246-.154-.986-.832-1.664C9.516 10.68 8.289 10 6 10c-2.29 0-3.516.68-4.168 1.332-.678.678-.83 1.418-.832 1.664h10zM11 7.5a.5.5 0 0 1 .5-.5h4a.5.5 0 0 1 0 1h-4a.5.5 0 0 1-.5-.5z"/>
                           </svg></a>
                       <?php }?>
                       <a class="pl-2" href="/Progetto/Utente/user?id=<?php echo $_smarty_tpl->tpl_vars['a']->value;?>
  ...
  <path fill-rule="evenodd" d="M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z"/>
            ...
            <div id="sebox">
                <ul>
                    <li>
                        <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['utente']->value->getSeguaci(), 'a');
$_smarty_tpl->tpl_vars['a']->do_else = true;
if ($_from !== null) foreach ($_from as $_smarty_tpl->tpl_vars['a']->value) {
$_smarty_tpl->tpl_vars['a']->do_else = false;
?>
                        <a href="/Progetto/Utente/user?id=<?php echo $_smarty_tpl->tpl_vars['a']->value;?>
"> <?php echo $_smarty_tpl->tpl_vars['a']->value;?>
</a>
                    </li>
                    <?php
  ...
  <path fill-rule="evenodd" d="M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z"/>
        ...
        <div id="wcbox">
            <ul>
                <li>
                    <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['utente']->value->getWatchlist(), 'a');
$_smarty_tpl->tpl_vars['a']->do_else = true;
if ($_from !== null) foreach ($_from as $_smarty_tpl->tpl_vars['a']->value) {
$_smarty_tpl->tpl_vars['a']->do_else = false;
?>
                    <a> <?php echo $_smarty_tpl->tpl_vars['a']->value->getNome();?>
</a>
                </li>
                <?php
}
...
<!--end-->
<?php echo '<script'; ?>
>$('#usern').on('hidden.bs.modal', function () {
        $(this).find('form').trigger('reset');
        resetuser();
    })<?php echo '</script'; ?>
>
<?php echo '<script'; ?>
>$('#pw').on('hidden.bs.modal', function () {
        $(this).find('form').trigger('reset');
        resetpw();
    })<?php echo '</script'; ?>
>
